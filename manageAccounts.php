...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#password').keyup(function() {
            ...
            // Display result
            if (strength < 2) {
                strengthIndicator.addClass('text-danger').html(
                    '<i class="fas fa-exclamation-triangle me-1"></i>Weak password');
            } else if (strength < 4) {
                strengthIndicator.addClass('text-warning').html(
                    '<i class="fas fa-info-circle me-1"></i>Moderate password');
            } else {
                strengthIndicator.addClass('text-success').html(
        ...
        $('#confirm_password').keyup(function() {
            ...
            if (password === confirmPassword) {
                feedback.removeClass('text-danger').addClass('text-success').html(
                    '<i class="fas fa-check-circle me-1"></i>Passwords match');
            } else {
                feedback.removeClass('text-success').addClass('text-danger').html(
        ...
        $('#addAccountModal').on('show.bs.modal', function() {
            ...
            $('.password-strength, #password-match-feedback').empty().removeClass(
