  ...
  [6450],
  {
    6515: function (t, e, i) {
      ...
      class g extends s.w {
        ...
        _afterNew() {
          super._afterNew(),
            ...
            this._disposers.push(
              this.axisRanges.events.onAll((t) => {
                if ("clear" === t.type)
                  l.each(t.oldValues, (t) => {
          ...
          t && ((t.axis = this), t.processAxis()),
            this.children.push(t),
            (this.ghostLabel = t.makeLabel(new s.z(this, void 0, {}), [])),
        ...
        zoom(t, e, i, s) {
          if (this.get("zoomable", !0))
            if (
              (this._updateFinals(t, e),
              this.get("start") !== t || this.get("end") != e)
            ) {
              let a = this._sAnimation,
                n = this._eAnimation,
                r = this.get("maxDeviation", 0.5) * Math.min(1, e - t);
              t < -r && (t = -r),
                e > 1 + r && (e = 1 + r),
                t > e && ([t, e] = [e, t]),
                h.isNumber(i) || (i = this.get("interpolationDuration", 0)),
                s || (s = "end");
              let o = this.getPrivate(
                  "maxZoomFactor",
              ...
              1 === e &&
                0 !== t &&
                (s = t < this.get("start", 0) ? "start" : "end"),
                0 === t &&
                  1 !== e &&
                  (s = e > this.get("end", 1) ? "end" : "start");
              let u = this.get("minZoomCount", 0),
                g = this.get("maxZoomCount", 1 / 0);
              h.isNumber(u) && (o = l / u);
              let c = 1;
              if (
                (h.isNumber(g) && (c = l / g),
              ...
              if (
                ((a && a.playing && a.to == t) || this.get("start") == t) &&
                ((n && n.playing && n.to == e) || this.get("end") == e)
              )
                return;
              if (i > 0) {
                let s,
                  a,
                  n = this.get("interpolationEasing");
                if (
                  (this.get("start") != t &&
                    (s = this.animate({
                      key: "start",
        ...
        _prepareChildren() {
          if (
            ...
            let e = this.get("start", 0),
              i = this.get("end", 1),
              s = this.get("maxDeviation", 0.5) * Math.min(1, i - e);
            if (e < -s) {
              let t = e + s;
              (e = -s),
                this.setRaw("start", e),
                this.isDirty("end") && this.setRaw("end", i - t);
            }
            if (i > 1 + s) {
              let t = i - 1 - s;
              (i = 1 + s),
                this.setRaw("end", i),
                this.isDirty("start") && this.setRaw("start", e - t);
            }
          }
          const t = this.get("renderer");
          if (
            ((t._start = this.get("start")),
            (t._end = this.get("end")),
            (t._inversed = t.get("inversed", !1)),
            (t._axisLength = t.axisLength() / (t._end - t._start)),
            t._updateLC(),
            ...
            if (e) {
              ...
              e.addTag("axis"),
                e.addTag(this.className.toLowerCase()),
                e._applyThemes(),
                i &&
                  (e.set("themeTags", u.mergeTags(e.get("themeTags"), i)),
                  e.label._applyThemes());
            }
          }
        }
        ...
        processChart(t) {
          (this.chart = t),
            (this.get("renderer").chart = t),
            t.gridContainer.children.push(this.gridContainer),
            t.topGridContainer.children.push(this.topGridContainer),
            t.axisHeadersContainer.children.push(this.axisHeader),
            this.on("start", () => {
        ...
        _createAssets(t, e, i) {
          ...
          if (l) {
            let a = l.get("themeTags"),
              n = !1;
            i
              ? -1 == (null == a ? void 0 : a.indexOf(o)) && (n = !0)
              : -1 != (null == a ? void 0 : a.indexOf(o)) && (n = !0),
              n &&
                (null === (s = l.parent) ||
                  void 0 === s ||
          ...
          if (h) {
            let s = h.get("themeTags"),
              n = !1;
            i
              ? -1 == (null == s ? void 0 : s.indexOf(o)) && (n = !0)
              : -1 != (null == s ? void 0 : s.indexOf(o)) && (n = !0),
              n &&
                (null === (a = h.parent) ||
                  void 0 === a ||
          ...
          if (u) {
            let s = !1,
              a = u.get("themeTags");
            i
              ? -1 == (null == a ? void 0 : a.indexOf(o)) && (s = !0)
              : -1 != (null == a ? void 0 : a.indexOf(o)) && (s = !0),
              s &&
                (null === (n = u.parent) ||
                  void 0 === n ||
                  n.children.removeValue(u),
                r.makeTick(t, e),
                u.dispose(),
                r.ticks.removeValue(u));
          } else r.makeTick(t, e);
          i || t.get("axisFill") || r.makeAxisFill(t, e),
            this._processBullet(t);
        }
        _processBullet(t) {
          let e = t.get("bullet"),
            i = this.get("bullet");
          if (
            (e || !i || t.get("isRange") || (e = i(this._root, this, t)), e)
          ) {
            e.axis = this;
        ...
        _afterChanged() {
          super._afterChanged();
          const t = this.chart;
          t && (t._updateChartLayout(), t.axisHeadersContainer.markDirtySize()),
        ...
        _handleCursorPosition(t, e) {
          (t = this.get("renderer").toAxisPosition(t)),
            (this._cursorPosition = t),
            (this._snapToSeries = e),
            this.updateTooltip();
        }
        updateTooltip() {
          ...
          h.isNumber(e) &&
            ...
            this.get("snapTooltip") &&
              (e = this.roundAxisPosition(e, this.get("tooltipLocation", 0.5))),
            this.setPrivateRaw("tooltipPosition", e),
            i &&
              (s.updateTooltipBounds(i),
              h.isNaN(e)
                ? i.hide(0)
                : (this._updateTooltipText(i, e),
                  s.positionTooltip(i, e),
                  e < this.get("start", 0) || e > this.get("end", 1)
                    ? i.hide(0)
                    : i.show(0))));
        }
      ...
      Object.defineProperty(g, "className", {
        ...
        Object.defineProperty(g, "classNames", {
          ...
          configurable: !0,
          writable: !0,
          value: s.w.classNames.concat([g.className]),
        });
    },
    2586: function (t, e, i) {
      i.d(e, {
    ...
    6284: function (t, e, i) {
      ...
      class l extends s.Y {
        ...
        _afterNew() {
          (this._settings.themeTags = r.mergeTags(this._settings.themeTags, [
            "renderer",
            "x",
          ])),
            super._afterNew(),
          ...
          if (this.isDirty(e) || this.isDirty(i)) {
            ...
            if ((this.get(i) ? t.addTag(i) : t.removeTag(i), s)) {
              if (this.get(e)) {
                ...
                -1 == i.indexOf(t) && i.insertIndex(0, t),
                  t.addTag(e),
                  a.moveValue(this);
              } else {
                const i = s.bottomAxesContainer.children;
                -1 == i.indexOf(t) && i.moveValue(t),
                  t.removeTag(e),
                  a.moveValue(this, 0);
              }
        ...
        toAxisPosition(t) {
          const e = this._start || 0,
            i = this._end || 1;
          return (
            (t = ((t -= this._ls) * (i - e)) / this._lc),
            this.get("inversed") ? i - t : e + t
          );
        }
        toGlobalPosition(t) {
          const e = this._start || 0,
            i = this._end || 1;
          return (
            this.get("inversed") ? (t = i - t) : (t -= e),
            (t = (t / (i - e)) * this._lc) + this._ls
          );
        }
        _updateLC() {
          const t = this.axis,
          ...
          if (e) {
            ...
            (this._lc = this.axisLength() / i),
              (this._ls = (t.x() - e.get("paddingLeft", 0)) / i);
          }
        }
        _updatePositions() {
          const t = this.axis,
            e =
              t.x() -
              r.relativeToValue(t.get("centerX", 0), t.width()) -
              t.parent.get("paddingLeft", 0);
          t.gridContainer.set("x", e),
            t.topGridContainer.set("x", e),
            t.bulletsContainer.set("y", this.y());
          const i = t.chart;
          if (i) {
            const e = i.plotContainer,
              s = t.axisHeader;
            let a = t.get("marginLeft", 0),
              n = t.x() - a;
            const r = t.parent;
            r && (n -= r.get("paddingLeft", 0)),
              s.children.length > 0
                ? ((a = t.axisHeader.width()), t.set("marginLeft", a + 1))
                : s.set("width", a),
              s.setAll({ x: n, y: -1, height: e.height() + 2 });
          }
        }
        processAxis() {
          super.processAxis();
          ...
          t.set("layout", e),
            t.labelsContainer.set("width", a.AQ),
            t.axisHeader.setAll({ layout: e });
        }
        axisLength() {
        ...
        updateTick(t, e, i, s) {
          if (t) {
            ...
            (r =
              n.isNumber(s) && s > 1
                ? t.get("multiLocation", r)
                : t.get("location", r)),
              n.isNumber(i) && i != e && (e += (i - e) * r),
              t.set("x", this.positionToCoordinate(e));
        ...
        updateLabel(t, e, i, s) {
          if (t) {
            ...
            this.get("opposite")
              ? o
                ? (t.set("position", "absolute"), t.set("y", 0))
                : (t.set("position", "relative"), t.set("y", a.AQ))
              : o
              ? (t.set("y", 0), t.set("position", "absolute"))
              : (t.set("y", void 0), t.set("position", "relative")),
              n.isNumber(i) && i != e && (e += (i - e) * r),
              t.set("x", this.positionToCoordinate(e)),
              this.toggleVisibility(
                t,
        ...
        updateBullet(t, e, i) {
          if (t) {
            ...
            if (s) {
              ...
              let r = this.axis.roundAxisPosition(e, a),
                o = this.axis._bullets[r],
                l = -1;
              if ((this.get("opposite") && (l = 1), t.get("stacked")))
                if (o) {
                  let t = o.get("sprite");
                  t && s.set("y", t.y() + t.height() * l);
                } else s.set("y", 0);
              (this.axis._bullets[r] = t),
                s.set("x", this.positionToCoordinate(e)),
                this.toggleVisibility(s, e, 0, 1);
            }
          }
        }
        updateFill(t, e, i) {
          if (t) {
            ...
            let s = this.positionToCoordinate(e),
        ...
        updateTooltipBounds(t) {
          ...
          this.get("opposite")
            ...
            ? ((h = "down"), (n = s.y - i), (l = i))
            : ((h = "up"), (n = s.y), (l = i));
          const u = { left: a, right: a + o, top: n, bottom: n + l },
            g = t.get("bounds");
          r.sameBounds(u, g) ||
            (t.set("bounds", u), t.set("pointerOrientation", h));
        }
      }
    ...
    7909: function (t, e, i) {
      ...
      class l extends s.Y {
        ...
        _changed() {
          ...
          if (this.isDirty(i) || this.isDirty(s)) {
            ...
            if ((this.get(s) ? t.addTag(s) : t.removeTag(s), a)) {
              if (this.get(i)) {
                ...
                -1 == s.indexOf(t) && s.moveValue(t, 0),
                  t.addTag(i),
                  e.moveValue(this, 0);
              } else {
                const s = a.leftAxesContainer.children;
                -1 == s.indexOf(t) && s.moveValue(t),
                  t.removeTag(i),
                  e.moveValue(this);
              }
              t.ghostLabel._applyThemes(),
          ...
          a && (this.get(i) ? e.set("centerX", 0) : e.set("centerX", n)),
            e.setPrivate("width", n);
        }
        processAxis() {
          super.processAxis();
          const t = this.axis;
          ...
          t.set("layout", e),
            t.labelsContainer.set("height", a.AQ),
            t.axisHeader.set("layout", e);
        }
        _updatePositions() {
          const t = this.axis,
            e = t.y() - r.relativeToValue(t.get("centerY", 0), t.height());
          t.gridContainer.set("y", e),
            t.topGridContainer.set("y", e),
            t.bulletsContainer.set("x", this.x());
          const i = t.chart;
          if (i) {
            const e = i.plotContainer,
              s = t.axisHeader;
            ...
            s.children.length > 0
              ? ((a = t.axisHeader.height()), t.set("marginTop", a + 1))
              : s.set("height", a),
              s.setAll({ y: t.y() - a, x: -1, width: e.width() + 2 });
          }
        }
        axisLength() {
        ...
        updateLabel(t, e, i, s) {
          if (t) {
            ...
            a =
              n.isNumber(s) && s > 1
                ? t.get("multiLocation", a)
                : t.get("location", a);
            const r = this.get("opposite"),
              o = t.get("inside", this.get("inside", !1));
            r
              ? (t.set("x", 0),
                o
                  ? t.set("position", "absolute")
                  : t.set("position", "relative"))
              : o
              ? (t.set("x", 0), t.set("position", "absolute"))
              : (t.set("x", void 0), t.set("position", "relative")),
              n.isNumber(i) && i != e && (e += (i - e) * a),
              t.set("y", this.positionToCoordinate(e)),
              this.toggleVisibility(
                t,
                e,
                t.get("minPosition", 0),
        ...
        updateBullet(t, e, i) {
          if (t) {
            ...
            if (s) {
              ...
              (this.axis._bullets[r] = t),
                s.set("y", this.positionToCoordinate(e)),
                this.toggleVisibility(s, e, 0, 1);
            }
          }
        }
        ...
        positionToCoordinate(t) {
          return this._inversed
            ? (t - this._start) * this._axisLength
            : (this._end - t) * this._axisLength;
        }
        positionTooltip(t, e) {
        ...
        updateTooltipBounds(t) {
          ...
          this.get("opposite")
            ...
            ? ((h = "left"), (n = s.x), (l = i))
            : ((h = "right"), (n = s.x - i), (l = i));
          const u = { left: n, right: n + l, top: a, bottom: a + o },
            g = t.get("bounds");
          r.sameBounds(u, g) ||
            (t.set("bounds", u), t.set("pointerOrientation", h));
        }
    ...
    5638: function (t, e, i) {
      ...
      class c extends a.m {
        ...
        _afterNew() {
          (this._settings.themeTags = u.mergeTags(this._settings.themeTags, [
            "axis",
          ])),
            super._afterNew(),
        ...
        _setBaseInterval(t) {
          this.setPrivateRaw("baseInterval", t),
            (this._baseDuration = g.getIntervalDuration(t));
        }
        _fixZoomFactor() {
        ...
        _groupData() {
          ...
          if (n.isNumber(t) && n.isNumber(e)) {
            ...
            if (
              (t
                ? this._setBaseInterval(t)
                : this._setBaseInterval(this.get("baseInterval")),
              this.isDirty("groupInterval"))
            ) {
              let t = this.get("groupInterval");
              t &&
                (this.setRaw("groupIntervals", [t]), this._handleRangeChange());
            }
        ...
        _groupSeriesData(t) {
          if (this.get("groupData") && !t.get("groupDataDisabled")) {
            ...
            l.each(a, (t) => {
              g.getIntervalDuration(t) > i && e.push(t);
            }),
              (t._dataSets = {});
            const r =
            ...
            let o;
            const u = t.get("baseAxis");
            t.get("xAxis") === u
              ? (o = t._valueYFields)
              : t.get("yAxis") === u && (o = t._valueXFields);
            let c = t._mainDataItems,
            ...
            p && (b = !0),
              l.each(e, (e) => {
                ...
                let v,
                  f,
                  P = g.getDuration(e.timeUnit);
                c[0] && (v = c[0].get(r)),
                  l.each(c, (c) => {
                    let y,
                      D = c.get(r),
                      M = g.roun(D, e.timeUnit, e.count, this._root, v);
                    a < M - P / 24
                      ? ((y = h.copy(c.dataContext)),
                        (i = new s.z(t, y, t._makeDataItem(y))),
                        i.setRaw(r, M),
                        t._dataSets[u].push(i),
                        l.each(o, (t) => {
                          let e = c.get(t);
                          n.isNumber(e)
                            ? (i.setRaw(t, e),
                      ...
                      : (l.each(o, (t) => {
                        ...
                        b && i.get("originals").push(c)),
                      (a = M);
                  }),
                  p && f && p(f, e);
              }),
              t._dataSetId && t.setDataSet(t._dataSetId),
              this.markDirtySize(),
              this._seriesAdded &&
        ...
        getGroupInterval(t) {
          ...
          return (
            g.getIntervalDuration(i) < g.getIntervalDuration(e) &&
              (i = Object.assign({}, e)),
            i
          );
        }
        ...
        _handleRangeChange() {
          ...
          let t = Math.round(this.getPrivate("selectionMin")),
            e = Math.round(this.getPrivate("selectionMax"));
          if (n.isNumber(t) && n.isNumber(e)) {
            if (
              (0 == this.get("endLocation") && (e += 1),
            ...
            l.each(this.series, (i) => {
              if (i.get("baseAxis") === this) {
                let s =
                    this.getPrivate("name") +
                    this.get("renderer").getPrivate("letter"),
                  a = l.getFirstSortedIndex(i.dataItems, (e) =>
                    o.qu(e.get(s), t)
                  ).index;
                a > 0 && (a -= 1),
                  (e += this.baseDuration() * (1 - this.get("endLocation", 1)));
                let n = l.getSortedIndex(i.dataItems, (t) =>
                    o.qu(t.get(s), e)
                  ).index,
                  r = n;
                r > 1 && r--;
                const h = i.dataItems[a],
                  u = i.dataItems[r];
                let g, c;
                h && (c = h.get(s)), u && (g = u.get(s));
                let d = !1;
                null != g && null != c && (g < t || c > e) && (d = !0),
                  i.setPrivate("outOfSelection", d),
                  i.setPrivate("startIndex", a),
                  i.setPrivate("adjustedStartIndex", i._adjustStartIndex(a)),
                  i.setPrivate("endIndex", n),
        ...
        _getMinorInterval(t) {
          ...
          return (
            ...
            "week" == a &&
              (i =
                "week" !=
                (null === (e = this.getPrivate("baseInterval")) || void 0 === e
                  ? void 0
                  : e.timeUnit)
        ...
        _prepareAxisItems() {
          ...
          if (n.isNumber(t) && n.isNumber(e)) {
            ...
            let d = g.chooseInterval(0, a - i, r.gridCount(), c);
            g.getIntervalDuration(d) < this.baseDuration() &&
              (d = Object.assign({}, o));
            const m = g.getIntervalDuration(d);
            this._intervalDuration = m;
            const p = g.getNextUnit(d.timeUnit),
              b = e.utc,
              x = e.timezone;
            h = g.roun(i - m, d.timeUnit, d.count, e, t);
            let _,
              v = h - m;
            const f = this.get("dateFormats");
            this.setPrivateRaw("gridInterval", d);
            const P = r.get("minorLabelsEnabled"),
              y = r.get("minorGridEnabled", P);
            let D,
              M = 0;
            y &&
              ((D = this._getMinorInterval(d)), (M = g.getIntervalDuration(D)));
            let w = 0;
            for (; h < a + m; ) {
              let t;
              this.dataItems.length < u + 1
                ? ((t = new s.z(this, void 0, {})),
                  this._dataItems.push(t),
                  this.processDataItem(t))
                : (t = this.dataItems[u]),
                this._createAssets(t, []),
                this._toggleDataItem(t, !0),
                t.setRaw("value", h),
                t.setRaw("labelEndValue", void 0);
              let i =
                h + g.getDuration(d.timeUnit, d.count * this._getM(d.timeUnit));
              (i = g.roun(i, d.timeUnit, 1, e)), t.setRaw("endValue", i);
              let a = new Date(h);
              (_ = f[d.timeUnit]),
                p &&
                  ...
                  n.isNumber(v) &&
                  "year" != d.timeUnit &&
                  g.checkChange(h, v, p, b, x) &&
                  (_ = this.get("periodChangeDateFormats")[d.timeUnit]);
              const r = t.get("label");
              ...
              if (("week" == d.timeUnit && t.setRaw("labelEndValue", h), y)) {
                ...
                let i = d.timeUnit;
                "week" == i && (i = "day");
                let s = h + g.getDuration(i, this._getM(i));
                (s = g.roun(s, i, 1, e)), t.setRaw("labelEndValue", s);
              }
              if ((this._prepareDataItem(t, o), (v = h), (h = i), D)) {
                ...
                for (; r < h - 0.01 * M; ) {
                  ...
                  if (
                    (c &&
                      (P
                        ? c.set("text", e.dateFormatter.format(u, _))
            ...
            for (let t = u; t < this.dataItems.length; t++)
              this._toggleDataItem(this.dataItems[t], !1);
            for (let t = w; t < this.minorDataItems.length; t++)
              this._toggleDataItem(this.minorDataItems[t], !1);
            l.each(this.series, (t) => {
        ...
        _updateFinals(t, e) {
          this.setPrivateRaw("selectionMinFinal", this.positionToValue(t)),
            this.setPrivateRaw("selectionMaxFinal", this.positionToValue(e));
        }
        _getDelta() {
        ...
        _fixMin(t) {
          const e = this.getPrivate("baseInterval"),
            i = e.timeUnit;
          let s = g.roun(t, i, e.count, this._root),
            a = s + g.getDuration(i, e.count * this._getM(i));
          return (
            (a = g.roun(a, i, 1, this._root)),
        ...
        baseMainDuration() {
          return g.getIntervalDuration(this.get("baseInterval"));
        }
        processSeriesDataItem(t, e) {
            ...
            l.each(e, (e) => {
              ...
              if (n.isNumber(s)) {
                ...
                if (s >= a && s <= n);
                  ...
                  const r = i.timeUnit,
                    o = i.count;
                  (a = g.roun(s, r, o, this._root)),
                    (n = a + g.getDuration(r, o * this._getM(r))),
                    (n = g.roun(n, r, 1, this._root)),
                    (t.open[e] = a),
                    (t.close[e] = n);
                }
        ...
        getDataItemCoordinateX(t, e, i, s) {
          return this._settings.renderer.positionToCoordinate(
            this.getDataItemPositionX(t, e, i, s)
          );
        }
        ...
        getDataItemCoordinateY(t, e, i, s) {
          return this._settings.renderer.positionToCoordinate(
            this.getDataItemPositionY(t, e, i, s)
          );
        }
        roundAxisPosition(t, e) {
          let i = this.positionToValue(t);
          i -= (e - 0.5) * this.baseDuration();
          let s = this.getPrivate("baseInterval");
          if (!n.isNaN(i)) {
            const t = this._root.locale.firstDayOfWeek,
              a = s.timeUnit,
              n = this._root.utc,
              r = this._root.timezone,
              o = s.count;
            i = g.roun(i, a, o, this._root, this.getPrivate("min", 0));
            let l = g.getDateIntervalDuration(s, new Date(i), t, n, r);
            return (
              r &&
                ((i = g.roun(
        ...
        zoomToValues(t, e, i) {
          ...
          if (null != this.getPrivate("min") && null != this.getPrivate("max"))
            if (this.get("groupData")) {
              const s = this.getGroupInterval(e - t),
                a = this.get("baseInterval");
              let n = this.getIntervalMin(a),
                r = this.getIntervalMax(a) - 1;
              (r = g.roun(r, s.timeUnit, s.count, this.root)),
                (r += this._getM(s.timeUnit) * g.getIntervalDuration(s)),
                (r = g.roun(r, s.timeUnit, s.count, this.root));
              let o = g.roun(n, s.timeUnit, s.count, this.root),
                l = g.roun(r, s.timeUnit, s.count, this.root),
                h = (t - o) / (l - o),
                u = (e - o) / (l - o);
              this.zoom(h, u, i);
        ...
        getCellWidthPosition() {
          ...
          return n.isNumber(t) && n.isNumber(e)
            ? this._intervalDuration / (t - e)
            : 0.05;
        }
        nextPosition(t) {
          null == t && (t = 1);
          ...
          let a = this._nextTime(i, t, s),
            n = this.getPrivate("selectionMin", 0),
            o = this.getPrivate("selectionMax", 0),
            l = g.roun(n, s.timeUnit, s.count, this._root),
            h = g.roun(o, s.timeUnit, s.count, this._root);
          return (
            (a += e),
            (a = r.fitToRange(a, l + e, h - e)),
            this.toGlobalPosition(this.valueToPosition(a))
          );
        }
        _nextTime(t, e, i) {
          return g.roun(
            t + e * this.baseDuration(),
            i.timeUnit,
            i.count,
            this._root
          );
    ...
    8701: function (t, e, i) {
      ...
      class u extends s.S {
        ...
        _updateDates(t, e) {
          if (!e.get("ignoreMinMax")) {
            const e = this._getDates(),
              i = n.getSortedIndex(e, (e) => r.qu(e, t));
          ...
          if (!this._customDates) {
            ...
            (t.length = 0),
              n.each(this.series, (t) => {
                let e = "valueX";
                t.get("yAxis") == this && (e = "valueY"),
                  n.each(t.dataItems, (i) => {
                    let s = i.get(e);
                    l.isNumber(s) && i.open && this._updateDates(i.open[e], t);
                  });
              });
            const e = this.get("extraMax", 0),
            ...
            if (e > 0) {
              ...
              let a = t[s - 1];
              if (l.isNumber(a))
                for (let e = s - 1; e < s + i; e++)
                  (a += o.getDuration(h, r * this._getM(h))),
                    (a = o.roun(a, h, r, this._root)),
                    t.push(a);
            }
            if (i > 0) {
              const e = s * i;
        ...
        valueToPosition(t) {
          const e = this._getDates(),
            ...
            a = e.length - i - (1 - s),
            o = n.getSortedIndex(e, (e) => r.qu(e, t));
          let l = o.index;
        ...
        positionToValue(t) {
          const e = this.get("startLocation", 0),
            i = this.get("endLocation", 1),
            s = this._getDates();
          let a = Math.round(s.length - e - (1 - i)),
            n = t * a,
            r = Math.floor(n);
          return (
            r < 0 && (r = 0),
            r > a - 1 && (r = a - 1),
            s[r] + (n - r + e) * this.baseDuration()
          );
        }
        _fixZoomFactor() {
          this.setPrivateRaw(
        ...
        zoomToDates(t, e, i) {
          const s = this._getDates(),
            a = s.length;
          let o = n.getSortedIndex(s, (e) => r.qu(e, t.getTime())),
            l = s[Math.min(o.index, a - 1)];
          o = n.getSortedIndex(s, (t) => r.qu(t, e.getTime()));
          let h = s[o.index];
          o.index >= a && (h = s[a - 1] + this.baseDuration()),
        ...
        zoomToValues(t, e, i) {
          ...
          (t = h.fitToRange(t, s, a)),
            ...
            this.zoom(this.valueToPosition(t), this.valueToPosition(e), i);
        }
        _prepareAxisItems() {
          let t = this.getPrivate("selectionMin", 0),
          ...
          if (l.isNumber(t) && l.isNumber(e)) {
            ...
            let p =
                u.axisLength() /
                Math.max(u.get("minGridDistance"), 1 / Number.MAX_SAFE_INTEGER),
              b = Math.min(g, Math.ceil((m - d) / p));
            (b = Math.max(1, b)),
              (d = Math.floor(d / b) * b),
              (this._frequency = b),
              n.each(this.dataItems, (t) => {
            ...
            f < c &&
              ((_ = Object.assign({}, v)), (f = o.getIntervalDuration(_))),
            ...
            const w = u.get("minorLabelsEnabled"),
              I = u.get("minorGridEnabled", w);
            let T,
              N,
              A = 0;
            I &&
              ((T = this._getMinorInterval(_)), (A = o.getIntervalDuration(T)));
            let C = this._getIndexes(
              M,
              this.getPrivate("selectionMax", M) + f,
              _,
              this.getPrivate("min", M)
            );
            if (C.length > 0) {
              let t = 0;
              this._m = 0;
              let e = M - 10 * f;
              const g = o.getNextUnit(P);
              if (T) {
                let t = h[C[0]];
                this._addMinorGrid(t - f, t, A, T);
              }
              let c = (u.axisLength() / u.gridCount()) * 0.5;
              n.each(C, (n) => {
                var d;
                let m;
                this.dataItems.length < t + 1
                ...
                g &&
                  ...
                  l.isNumber(e) &&
                  "year" != P &&
                  o.checkChange(p, e, g, s, r) &&
                  (v = this.get("periodChangeDateFormats")[P]),
                  this._createAssets(m, []);
                const D = m.get("label");
                D && D.set("text", i.dateFormatter.format(b, v)),
                  this._toggleDataItem(m, !0);
                let M = _.count;
                if (("week" == P && m.setRaw("labelEndValue", p), I)) {
                  let t = _.timeUnit;
                  if (
                    ("week" == t && (t = "day"), M > 1 || "week" == _.timeUnit)
                  ) {
                    let e =
                        o.roun(p, t, 1, i) + o.getDuration(t, this._getM(t)),
                ...
                if (
                  (this._prepareDataItem(m, M),
                  D && N && "X" == u.getPrivate("letter"))
                ) {
                  let t = N.get("label");
                  if (t && D.x() - t.x() < c) {
                ...
                T && this._addMinorGrid(p, x, A, T),
                  t++,
                  D && D.getPrivate("visible") && (N = m),
                  (e = p);
              });
            }
            n.each(this.series, (t) => {
        ...
        _pickWorse(t, e, i) {
          const s = i.timeUnit,
            a = t.get("value", 0),
            n = e.get("value", 0);
          return "hour" == s && new Date(a).getDate() != new Date(n).getDate()
            ? t
            : e;
        }
        _addMinorGrid(t, e, i, s) {
          const r = this.get("minorDateFormats", this.get("dateFormats")),
            l = s.timeUnit;
          let h = t + o.getDuration(l, this._getM(l));
          h = o.roun(h, l, 1, this._root);
          let u = e - 0.5 * i,
            g = this._getIndexes(h, u, s, h);
          const c = this._getDates();
          n.each(g, (t) => {
            let e;
            this.minorDataItems.length < this._m + 1
              ? ((e = new a.z(this, void 0, {})),
                this.minorDataItems.push(e),
                this.processDataItem(e))
              : (e = this.minorDataItems[this._m]),
              (h = c[t]),
              e.setRaw("value", h),
              e.setRaw("endValue", h + i),
              e.setRaw("index", t),
              this._createAssets(e, ["minor"], !0);
            const s = e.get("label");
            if (s)
        ...
        _getIndexes(t, e, i, s) {
          ...
          for ("day" == r && (t = s); t <= e; ) {
            t = o.roun(t, r, l, g);
            let e = this.valueToIndex(t),
              i = c[e];
            if ("day" == r && "day" == u.timeUnit)
              this._hasDate(t) && d++,
                d == l && (t >= x - 2 * b && n.move(a, e), (d = 0)),
                (t += p),
                (t = o.roun(t, r, 1, g));
            else {
              if (i < t)
                for (let s = e, a = c.length; s < a; s++)
                  if (((i = c[s]), i >= t)) {
                    e = s;
                    break;
                  }
              n.move(a, e), (t += b), (t = o.roun(t, r, l, g));
            }
            if ((t == m && ((t += b + p), (t = o.roun(t, r, l, g))), t == m))
              break;
            m = t;
          }
          return a;
      ...
      Object.defineProperty(u, "className", {
        ...
        Object.defineProperty(u, "classNames", {
          ...
          configurable: !0,
          writable: !0,
          value: s.S.classNames.concat([u.className]),
        });
    },
    7261: function (t, e, i) {
      i.d(e, {
      ...
      class u extends a.R {
        ...
        _groupData() {}
        _formatText(t) {
          const e = this.get("numberFormat"),
            i = this.getNumberFormatter();
          let s = "";
          return (
            (s = e
              ? i.format(t, e)
              : i.format(t, void 0, this.getPrivate("stepDecimalPlaces"))),
            s
          );
        }
        _prepareAxisItems() {
          ...
          if (r.isNumber(t) && r.isNumber(e)) {
            ...
            if (e) {
              ...
              (g = h),
                g <= 0 &&
                  ((g = 1),
                  i < 1 &&
                    (g = r.isNumber(this._minRealLog)
                      ? this._minRealLog
                      : Math.pow(10, -50))),
                (u = Math.log(n - i) * Math.LOG10E - Math.log(g) * Math.LOG10E),
                u > 2 && (h = Math.pow(10, Math.log(g) * Math.LOG10E - 50));
            }
            const c = this.get("renderer"),
            ...
            let x = 2;
            l.round(b / 5, 10) % 1 == 0 && (x = 5),
              l.round(b / 10, 10) % 1 == 0 && (x = 10);
            let _ = i / x,
              v = 0,
              f = 0,
              P = -1 / 0;
            for (; h < n; ) {
              ...
              if (
                (e && u > 2
                  ? (n = Math.pow(10, Math.log(g) * Math.LOG10E + v - 50))
                  : (n += i),
                m)
              ) {
                let t = h + _;
                for (
                  e &&
                  (u > 2 && (_ = this._adjustMinMax(h, n, 10).step),
                  (t = h + _));
                  t < n - 1e-11 * i;
              ...
              if (r < 1 && !e) {
                let t =
                  Math.round(Math.abs(Math.log(Math.abs(r)) * Math.LOG10E)) + 2;
                h = l.round(h, t);
              }
              v++, (P = h);
            }
            for (let t = v; t < this.dataItems.length; t++)
              this._toggleDataItem(this.dataItems[t], !1);
            for (let t = f; t < this.minorDataItems.length; t++)
              this._toggleDataItem(this.minorDataItems[t], !1);
        ...
        _prepareDataItem(t, e) {
          ...
          r.isNumber(a) && ((o = this.valueToPosition(a)), (l = o)),
            t.get("isRange") && null == a && (l = n);
          let h = o,
            u = t.get("labelEndValue");
          null != u && (h = this.valueToPosition(u)),
            i.updateLabel(t.get("label"), n, h, e);
          const g = t.get("grid");
          if (
            (i.updateGrid(g, n, o),
            g &&
              (s == this.get("baseValue", 0)
                ? (g.addTag("base"), g._applyThemes())
                : g.hasTag("base") && (g.removeTag("base"), g._applyThemes())),
            i.updateTick(t.get("tick"), n, h, e),
            i.updateFill(t.get("axisFill"), n, l),
            this._processBullet(t),
            i.updateBullet(t.get("bullet"), n, o),
            !t.get("isRange"))
          ) {
        ...
        _handleRangeChange() {
          let t = this.positionToValue(this.get("start", 0)),
            e = this.positionToValue(this.get("end", 1));
          const i = this.get("renderer").gridCount();
          let s = this._adjustMinMax(t, e, i, !0),
            a = h.decimalPlaces(s.step);
          this.setPrivateRaw("stepDecimalPlaces", a),
            (t = l.round(t, a)),
            (e = l.round(e, a)),
            (s = this._adjustMinMax(t, e, i, !0));
          let n = s.step;
          (t = s.min),
            (e = s.max),
            (this.getPrivate("selectionMin") === t &&
              this.getPrivate("selectionMax") === e &&
              this.getPrivate("step") === n) ||
              (this.setPrivateRaw("selectionMin", t),
              this.setPrivateRaw("selectionMax", e),
        ...
        positionToValue(t) {
          ...
          return this.get("logarithmic")
            ? Math.pow(
                Math.E,
                (t * (Math.log(i) * Math.LOG10E - Math.log(e) * Math.LOG10E) +
        ...
        valueToPosition(t) {
          ...
          if (this.get("logarithmic")) {
            ...
            return (
              (Math.log(t) * Math.LOG10E - Math.log(e) * Math.LOG10E) /
              (Math.log(i) * Math.LOG10E - Math.log(e) * Math.LOG10E)
            );
          }
          return (t - e) / (i - e);
        }
        ...
        getDataItemPositionX(t, e, i, s) {
          let a = t.get(e);
          return (
            (a = t.get("stackToItemX")
              ? a * s + t.component.getStackedXValueWorking(t, e)
        ...
        getDataItemPositionY(t, e, i, s) {
          let a = t.get(e);
          return (
            (a = t.get("stackToItemY")
              ? a * s + t.component.getStackedYValueWorking(t, e)
              : this._baseValue + (a - this._baseValue) * s),
            this.valueToPosition(a)
          );
        }
            ...
            if (t) {
              ...
              if (t.dataItems.length > 0) {
                ...
                let i,
                  s,
                  a = t.endIndex();
                a < t.dataItems.length && a++,
                  t.get("yAxis") == this
                    ? ((i = "valueY"), (s = "vcy"))
                    : t.get("xAxis") == this && ((i = "valueX"), (s = "vcx"));
                let n = i + "Working";
                if (i)
                  for (let t = e; t < a; t++) {
                    let e = 0,
        ...
        _getSelectionMinMax() {
          ...
          this.get("logarithmic") &&
            ...
            null == this.get("extraMax") && (n = 0.2));
          const h = this.get("renderer").gridCount(),
            u = this.get("strictMinMaxSelection");
          let g = this.get("strictMinMax");
          if (r.isNumber(t) && r.isNumber(e)) {
            let c = e,
              d = t;
            if (
              (o.each(this.series, (t) => {
                if (!t.get("ignoreMinMax")) {
                  ...
                  if (t.get("xAxis") === this) {
                    if (!s) {
                      let s = t.getPrivate("minX"),
                        a = t.getPrivate("maxX");
                      (0 == t.startIndex() &&
                        t.endIndex() == t.dataItems.length) ||
                        ((s = void 0), (a = void 0)),
                        (e = t.getPrivate("selectionMinX", s)),
                        (i = t.getPrivate("selectionMaxX", a));
                    }
                  } else if (t.get("yAxis") === this && !s) {
                    let s = t.getPrivate("minY"),
                      a = t.getPrivate("maxY");
                    (0 == t.startIndex() &&
                      t.endIndex() == t.dataItems.length) ||
                      ((s = void 0), (a = void 0)),
                      (e = t.getPrivate("selectionMinY", s)),
                      (i = t.getPrivate("selectionMaxY", a));
                  }
                  t.isHidden() ||
                    t.isShowing() ||
                    (r.isNumber(e) && (c = Math.min(c, e)),
                    r.isNumber(i) && (d = Math.max(d, i)));
                }
              }),
              this.axisRanges.each((t) => {
                if (t.get("affectsMinMax")) {
                  let e = t.get("value");
                  null != e && ((c = Math.min(c, e)), (d = Math.max(d, e))),
                    (e = t.get("endValue")),
                    null != e && ((c = Math.min(c, e)), (d = Math.max(d, e)));
                }
              }),
              ...
              r.isNumber(i)
                ? (c = g ? i : t)
                : g && r.isNumber(this._minReal) && (c = this._minReal),
              r.isNumber(s)
                ? (d = g ? s : e)
                : g && r.isNumber(this._maxReal) && (d = this._maxReal),
              c === d)
            ) {
              let e = c;
              ...
              let i = this._adjustMinMax(c, d, h, g);
              (c = i.min), (d = i.max);
            }
            let m = c,
              p = d,
            ...
            (c = x.min),
              (d = x.max),
              (c = l.fitToRange(c, t, e)),
              (d = l.fitToRange(d, t, e)),
              (x = this._adjustMinMax(c, d, h, !0)),
              g || ((c = x.min), (d = x.max));
            ...
            if (
              (_ &&
                ((x = this._syncAxes(
                  ...
                  _.getPrivate(
                    "selectionMinFinal",
                    _.getPrivate("minFinal", 0)
                  ),
                  _.getPrivate(
                    "selectionMaxFinal",
                    _.getPrivate("maxFinal", 1)
                  ),
                  _.getPrivate("selectionStepFinal", _.getPrivate("step", 1))
                )),
                x.min < t && (x.min = t),
                x.max > e && (x.max = e),
                (c = x.min),
                (d = x.max)),
              g &&
                (r.isNumber(i) && (c = Math.max(c, i)),
                r.isNumber(s) && (d = Math.min(d, s))),
              u && ((c = m - (p - m) * a), (d = p + (p - m) * n)),
              g)
            ) {
              (c = r.isNumber(i) ? i : m),
                (d = r.isNumber(s) ? s : p),
                d - c <= 1e-8 &&
                  ((c -= this._deltaMinMax), (d += this._deltaMinMax));
              let t = d - c;
              (c -= t * a), (d += t * n);
            }
            this.get("logarithmic") &&
              (c <= 0 && (c = m * (1 - Math.min(a, 0.99))),
              c < t && (c = t),
              d > e && (d = e));
            let v = Math.min(
                20,
            ...
            this.setPrivateRaw("selectionMinFinal", c),
              this.setPrivateRaw("selectionMaxFinal", d),
              this.setPrivateRaw("selectionStepFinal", x.step),
              this.zoom(f, P);
          }
        }
        _getMinMax() {
          ...
          if (
            (o.each(this.series, (t) => {
              if (!t.get("ignoreMinMax")) {
                ...
                if (
                  (t.get("xAxis") === this
                    ? ((e = t.getPrivate("minX")), (a = t.getPrivate("maxX")))
                    : t.get("yAxis") === this &&
                      ((e = t.getPrivate("minY")), (a = t.getPrivate("maxY"))),
                  r.isNumber(e) && r.isNumber(a))
                ) {
            ...
            this.axisRanges.each((t) => {
              if (t.get("affectsMinMax")) {
                let e = t.get("value");
                null != e && ((i = Math.min(i, e)), (s = Math.max(s, e))),
                  (e = t.get("endValue")),
                  null != e && ((i = Math.min(i, e)), (s = Math.max(s, e)));
              }
            }),
          ...
          const u = i,
            g = s;
          let c = this.adapters.fold("min", i),
          ...
          let b = m;
          r.isNumber(e) && (b = !0);
          let x = this.get("renderer").gridCount(),
            _ = this._adjustMinMax(i, s, x, b);
          if (
            ((i = _.min),
            (s = _.max),
            (_ = this._adjustMinMax(i, s, x, !0)),
            (i = _.min),
            (s = _.max),
            m)
          ) {
            (i = r.isNumber(t) ? t : this._minReal),
              (s = r.isNumber(e) ? e : this._maxReal),
              s - i <= 1e-8 &&
                ((i -= this._deltaMinMax), (s += this._deltaMinMax));
            let o = s - i;
            (i -= o * a), (s += o * n);
          }
          (c = this.adapters.fold("min", i)),
            (d = this.adapters.fold("max", s)),
            r.isNumber(c) && (i = c),
            r.isNumber(d) && (s = d),
            h == 1 / 0 && (h = s - i);
          ...
          if (
            ...
            const t = this.get("interpolationDuration", 0),
              e = this.get("interpolationEasing");
            this.animatePrivate({ key: "min", to: i, duration: t, easing: e }),
              this.animatePrivate({
                key: "max",
                to: s,
                duration: t,
        ...
        _fixZoomFactor() {}
        _getDelta(t) {
          let e = Math.log(Math.abs(t)) * Math.LOG10E,
        ...
        _adjustMinMax(t, e, i, s) {
          ...
          let a = t,
            ...
            o = e - t;
          0 === o && (o = Math.abs(e));
          let h = Math.log(Math.abs(o)) * Math.LOG10E,
            u = Math.pow(10, Math.floor(h));
          u /= 10;
          let g = u;
          s && (g = 0),
            s
              ? ((t = Math.floor(t / u) * u), (e = Math.ceil(e / u) * u))
              : ((t = Math.ceil(t / u) * u - g),
                (e = Math.floor(e / u) * u + g)),
            t < 0 && a >= 0 && (t = 0),
            e > 0 && n <= 0 && (e = 0),
            (h = Math.log(Math.abs(o)) * Math.LOG10E),
            (u = Math.pow(10, Math.floor(h))),
            (u /= 100);
          let c = Math.ceil(o / i / u) * u,
            d = Math.pow(10, Math.floor(Math.log(Math.abs(c)) * Math.LOG10E)),
            m = Math.ceil(c / d);
          m > 5 ? (m = 10) : m <= 5 && m > 2 && (m = 5),
            (c = Math.ceil(c / (d * m)) * d * m);
          ...
          d < 1 &&
            ((b =
              Math.round(Math.abs(Math.log(Math.abs(d)) * Math.LOG10E)) + 1),
            (c = l.round(c, b)));
          let x,
            _ = Math.floor(t / c);
          return (
            (t = l.round(c * _, b)),
            (x = s ? Math.floor(e / c) : Math.ceil(e / c)),
            x === _ && x++,
            (e = l.round(c * x, b)) < n && (e += c),
            t > a && (t -= c),
            (c = this.fixSmallStep(c)),
            { min: t, max: e, step: c }
          );
        }
        getTooltipText(t, e) {
        ...
        zoomToValues(t, e, i) {
          ...
          null != this.getPrivate("min") &&
            ...
            this.zoom((t - s) / (a - s), (e - s) / (a - s), i);
        }
        _syncAxes(t, e, i, s, a, n) {
          if (this.get("syncWithAxis")) {
            let o = Math.round(a - s) / n,
              l = Math.round((e - t) / i),
        ...
        _checkSync(t, e, i, s) {
          let a = (e - t) / i;
          for (let t = 1; t < s; t++)
            if (l.round(a / t, 1) == s || a * t == s) return !0;
          return !1;
        }
        getCellWidthPosition() {
          let t = this.getPrivate("selectionMax", this.getPrivate("max")),
            e = this.getPrivate("selectionMin", this.getPrivate("min"));
          return r.isNumber(t) && r.isNumber(e)
            ? this.getPrivate("step", 1) / (t - e)
            : 0.05;
        }
        nextPosition(t) {
          null == t && (t = 1),
          ...
          return (
            (e += this.getPrivate("step", 1) * t),
            (e = l.fitToRange(
              e,
              this.getPrivate("selectionMin", 0),
              this.getPrivate("selectionMax", 1)
            )),
            this.toGlobalPosition(this.valueToPosition(e))
          );
        }
      }
      Object.defineProperty(u, "className", {
        ...
        Object.defineProperty(u, "classNames", {
          ...
          configurable: !0,
          writable: !0,
          value: a.R.classNames.concat([u.className]),
        });
    },
    2976: function (t, e, i) {
      i.d(e, {
      ...
      class h extends s.d {
          ...
          super(...arguments),
            Object.defineProperty(this, "columns", {
              ...
              value: this.addDisposer(
                new r.o(n.YS.new({ themeTags: ["autocolor"] }), () =>
                  a.j._new(
                    this._root,
                    {
        ...
        _updateGraphics(t, e) {
          ...
          let n,
            ...
            m = this.get("vcy", 1),
            p = this.get("vcx", 1),
            b = this.get("locationX", t.get("locationX", 0.5)),
            x = this.get("locationY", t.get("locationY", 0.5)),
          ...
          if (s === a) {
            ...
            (r = i.getDataItemPositionX(t, this._xLowField, 1, p)),
              (u = i.getDataItemPositionX(t, this._xHighField, 1, p)),
              (h = Math.max(e, a)),
              (n = Math.min(e, a));
            let b = this._aLocationY0 + v - 0.5,
              _ = this._aLocationY1 + x - 0.5;
            (o = s.getDataItemPositionY(t, this._yField, b + (_ - b) / 2, m)),
              (l = o),
              (g = o),
              (c = o),
              (d = "horizontal");
            ...
            (l = s.getDataItemPositionY(t, this._yLowField, 1, m)),
              (c = s.getDataItemPositionY(t, this._yHighField, 1, m)),
              (g = Math.max(e, a)),
              (o = Math.min(e, a));
            let x = this._aLocationX0 + _ - 0.5,
              v = this._aLocationX1 + b - 0.5;
            (n = i.getDataItemPositionX(t, this._xField, x + (v - x) / 2, p)),
              (r = n),
              (h = n),
              (u = n),
              (d = "vertical");
          }
          this._updateCandleGraphics(t, n, r, o, l, h, u, g, c, d);
        }
        _updateCandleGraphics(t, e, i, s, a, n, r, o, h, u) {
          let g = t.get("graphics");
          if (g) {
            let c = this.getPoint(e, s),
              d = this.getPoint(i, a),
              m = this.getPoint(n, o),
              p = this.getPoint(r, h),
              b = g.x(),
        ...
        _processAxisRange(t) {
          super._processAxisRange(t),
            (t.columns = new r.o(n.YS.new({}), () =>
              a.j._new(
                this._root,
                {
                  themeTags: o.mergeTags(
    ...
    3405: function (t, e, i) {
        ...
        constructor() {
          super(...arguments),
            ...
            Object.defineProperty(this, "overlay", {
              ...
              writable: !0,
              value: this.children.push(
                n.T.new(this._root, { themeTags: ["overlay"], interactive: !1 })
              ),
            });
        }
        _afterNew() {
          ...
          e.set("interactive", !1),
            e.remove("background"),
            e.children.removeValue(this.chart.zoomOutButton),
            super._afterNew();
        }
        _updateThumb() {
          super._updateThumb(),
            this.overlay.set("draw", (t) => {
      ...
      class b extends u.R {
        ...
        _prepareChildren() {
          ...
          this._valuesDirty &&
            ((this._itemMap = {}),
            g.each(this.dataItems, (t) => {
              t.setRaw("index", e), (this._itemMap[t.get("category")] = t), e++;
            }),
            this.setPrivateRaw("maxZoomFactor", t)),
            this.setPrivateRaw(
              "startIndex",
              Math.max(Math.round(this.get("start", 0) * t), 0)
            ),
            this.setPrivateRaw(
              "endIndex",
              Math.min(Math.round(this.get("end", 1) * t), t)
            ),
            (this._sizeDirty ||
              this._valuesDirty ||
              this.isDirty("start") ||
        ...
        _handleRangeChange() {
          g.each(this.series, (t) => {
            let e = this.dataItems[this.startIndex()].get("category"),
              i = this.dataItems[this.endIndex() - 1].get("category"),
              s = t.get("baseAxis"),
              a = t.get("xAxis"),
              n = t.get("yAxis");
            if (a instanceof b && n instanceof b) t._markDirtyAxes();
            else if (s === this) {
              let r,
                o,
                l = n;
              if (
                (a === s
                  ? (t.get("categoryXField") && (r = "categoryX"),
                    t.get("openCategoryXField") && (o = "openCategoryX"))
                  : n === s &&
                    (t.get("categoryYField") && (r = "categoryY"),
                    t.get("openCategoryYField") && (o = "openCategoryY"),
                    (l = a)),
                l instanceof p.m && (r || o))
              ) {
                let s, a;
                ...
                let n = 0,
                  l = t.dataItems.length;
                s && (n = t.dataItems.indexOf(s)),
                  a && (l = t.dataItems.indexOf(a) + 1),
                  t.setPrivate("startIndex", n),
                  t.setPrivate("endIndex", l);
                let h = !1;
                for (let e = n; e < l; e++) {
                  const i = t.dataItems[e];
                  if (
                    (g.each(t.__valueXShowFields, (t) => {
                      null != i.get(t) && (h = !0);
                    }),
                    g.each(t.__valueYShowFields, (t) => {
                      null != i.get(t) && (h = !0);
                    }),
                    h)
                  )
        ...
        _prepareAxisItems() {
          ...
          let a = this.endIndex();
          a < i && a++;
          const n = e.get("minorLabelsEnabled"),
        ...
        _prepareDataItem(t, e, i) {
          ...
          let o,
            ...
            h = t.get("endCategory");
          h
            ? ((o = this.categoryToIndex(h)), c.isNumber(o) || (o = r))
            : (o = r);
          let u,
            g,
            d = this.indexToPosition(o, n);
          (u = t.get("isRange") ? o : r + this._frequency - 1),
            (g = this.indexToPosition(u, n)),
            s.updateLabel(t.get("label"), l, d, i),
            s.updateGrid(t.get("grid"), l, d),
            s.updateTick(t.get("tick"), l, d, i),
            s.updateFill(t.get("axisFill"), l, g),
            this._processBullet(t),
            s.updateBullet(t.get("bullet"), l, d);
        ...
        getX(t) {
          ...
          return e
            ? this._settings.renderer.positionToCoordinate(
                this.indexToPosition(e.get("index", 0))
              )
            : NaN;
        }
        getY(t) {
        ...
        roundAxisPosition(t, e) {
          return (
            (t += (0.5 - e) / this.dataItems.length),
            this.indexToPosition(this.axisPositionToIndex(t), e)
          );
        }
        ...
        _updateTooltipText(t, e) {
          t._setDataItem(this.dataItems[this.axisPositionToIndex(e)]),
        ...
        zoomToCategories(t, e, i) {
          this.zoomToIndexes(
            this.categoryToIndex(t),
            this.categoryToIndex(e) + 1,
            i
          );
        }
        getCellWidthPosition() {
      ...
      Object.defineProperty(b, "className", {
        ...
        Object.defineProperty(b, "classNames", {
          ...
          configurable: !0,
          writable: !0,
          value: u.R.classNames.concat([b.className]),
        });
      var x = i(1926);
      class _ extends b {
        constructor() {
        ...
        _prepareAxisItems() {
          ...
          let a =
              t.axisLength() /
              Math.max(t.get("minGridDistance"), 1 / Number.MAX_SAFE_INTEGER),
            n = Math.min(e, Math.ceil((s - i) / a));
          (i = Math.floor(i / n) * n), (this._frequency = n);
          for (let t = 0; t < e; t++)
            this._toggleDataItem(this.dataItems[t], !1);
          let r = Number(this.dataItems[i].get("category")),
          ...
          s - i < a &&
            (l =
              o -
              r -
              ((o - r) / this.baseDuration() - (s - i)) * this.baseDuration());
          let h = x.chooseInterval(0, l, a, this.get("gridIntervals"));
          const u = x.getNextUnit(h.timeUnit),
            d = this.getPrivate("baseInterval");
          x.getIntervalDuration(h) < this.baseDuration() &&
            (h = Object.assign({}, d));
          ...
          for (let t = i; t < s; t++) {
            let e = this.dataItems[t],
              i = e.get("index"),
              s = !1,
              a = Number(e.get("category")),
              r = new Date(a),
              o = x.getUnitValue(r, h.timeUnit);
            p = m[h.timeUnit];
            let l = !1;
            "year" != h.timeUnit &&
              "week" != h.timeUnit &&
              ...
              this.get("markUnitChange") &&
              c.isNumber(b) &&
              x.checkChange(a, b, u, this._root.utc) &&
              ((p = this.get("periodChangeDateFormats")[h.timeUnit]),
              i - 0.5 * n < _ && f.pop(),
              f.push({ format: p, dataItem: e }),
              (P = !0),
              (l = !0),
              (_ = i),
              (v = o));
            ...
            "day" === h.timeUnit || "week" === h.timeUnit
              ...
              !l &&
                g &&
                (i - 0.7 * n < _ && P && (s = !0),
                s || (f.push({ format: p, dataItem: e }), (_ = i), (v = o)),
                (P = !1)),
              (b = a);
          }
          if (f.length > 0) {
            ...
            g.each(f, (e) => {
              ...
              let a = Number(i.get("category")),
                r = new Date(a);
              const o = i.get("label");
              o && o.set("text", this._root.dateFormatter.format(r, s)),
                t++,
                this._prepareDataItem(i, t, n);
            });
          }
        }
        baseDuration() {
      ...
      class P extends p.m {
        ...
        _adjustMinMax(t, e, i, s) {
          let a;
          const n = this.getDurationFormatter(),
            r = this.get("baseUnit");
          if (
            (this.setRaw("maxPrecision", 0),
            "millisecond" == r || "second" == r || "minute" == r || "hour" == r)
          ) {
            i <= 1 && (i = 1), (i = Math.round(i));
            let s = e - t;
            0 === s && (s = Math.abs(e));
            let n = s / i,
              o = [60, 30, 20, 15, 10, 2, 1],
              l = 1;
            ...
            let h = Math.ceil((e - t) / l / i),
              u = Math.log(Math.abs(h)) * Math.LOG10E,
              g = Math.pow(10, Math.floor(u)) / 10,
              c = h / g;
            (h = d.closest(o, c) * g),
              (n = l * h),
              (a = {
          ...
          return (
            this.setPrivateRaw("durationFormat", n.getFormat(a.step, a.max, r)),
            a
          );
        }
        _formatText(t) {
      ...
      class L extends O.j {
        _draw() {
          const t = this._display;
          t.moveTo(this.get("lowX1", 0), this.get("lowY1", 0)),
            t.lineTo(this.get("highX1", 0), this.get("highY1", 0));
          let e = this.width(),
            i = this.height();
        ...
        constructor() {
          super(...arguments),
            Object.defineProperty(this, "columns", {
              ...
              writable: !0,
              value: this.addDisposer(
                new k.o(R.YS.new({ themeTags: ["autocolor"] }), () =>
                  L._new(
                    this._root,
                    {
      ...
      class G extends V.e {
        _afterNew() {
          this._setDefault("curveFactory", (0, Y.$)(this.get("tension", 0.5))),
            super._afterNew();
        }
        _updateChildren() {
          this.isDirty("tension") &&
            (this.set("curveFactory", (0, Y.$)(this.get("tension", 0.5))),
            (this._valuesDirty = !0)),
      ...
      class E extends V.e {
        _afterNew() {
          this._setDefault("curveFactory", (0, X.G)(this.get("tension", 0.5))),
            super._afterNew();
        }
        _updateChildren() {
          this.isDirty("tension") &&
            (this.set("curveFactory", (0, X.G)(this.get("tension", 0.5))),
            (this._valuesDirty = !0)),
            super._updateChildren();
        }
      }
      ...
      class Z extends V.e {
        ...
        _getPoints(t, e) {
          ...
          e.baseAxis === e.xAxis
            ? ((a -= s), (r += s))
            : e.baseAxis === e.yAxis && ((n -= s), (o += s));
          let l = e.xAxis.getDataItemPositionX(t, e.xField, a, e.vcx),
            h = e.yAxis.getDataItemPositionY(t, e.yField, n, e.vcy),
            u = e.xAxis.getDataItemPositionX(t, e.xField, r, e.vcx),
            g = e.yAxis.getDataItemPositionY(t, e.yField, o, e.vcy);
          if (this._shouldInclude(l)) {
            const c = this.getPoint(l, h),
              d = [c.x, c.y],
              m = this.getPoint(u, g),
              p = [m.x, m.y];
            if (e.fillVisible) {
              ...
              if (
                (e.baseAxis === e.xAxis
                  ? ((c = e.basePosY), (b = e.basePosY))
                  : e.baseAxis === e.yAxis &&
                    ((i = e.basePosX), (m = e.basePosX)),
                e.getOpen)
              ) {
                let l = t.get(e.xOpenField),
                  h = t.get(e.yOpenField);
                if (null != l && null != h)
                  if (
                    ((a = t.get("openLocationX", e.openLocationX)),
                    (n = t.get("openLocationY", e.openLocationY)),
                    (r = a),
                    (o = n),
                    e.baseAxis === e.xAxis
                      ? ((a -= s), (r += s))
                    ...
                    let s = t.get("stackToItemX"),
                      l = t.get("stackToItemY");
                    s
                      ? ((i = e.xAxis.getDataItemPositionX(
                          s,
                          e.xField,
                          a,
                          s.component.get("vcx")
                        )),
                        (m = e.xAxis.getDataItemPositionX(
                          s,
                          e.xField,
                          r,
                          s.component.get("vcx")
                      ...
                      l
                        ? ((c = e.yAxis.getDataItemPositionY(
                            l,
                            e.yField,
                            n,
                            l.component.get("vcy")
                          )),
                          (b = e.yAxis.getDataItemPositionY(
                            l,
                            e.yField,
                            o,
                            l.component.get("vcy")
